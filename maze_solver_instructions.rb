...
# Maze solver
    ...
    # In this exercise, we want to write a program that will find a route 
        # between two points in a maze.
            ...
            # It has an 'S' for the start point, and an 'E' for an end point.

    # You should write a program that will read in the maze, try to explore a 
            # path through it to the end, and then print out a completed path  
                # like so.
    ...
    # When you have found a first solution, write a version which will be sure 
    # to find the shortest path through the maze.

# Resources
# NB: Try taking a naive approach first. 
# Once you've got something working read on...

    # Reading Files progzoo
        # https://progzoo.net/wiki/Ruby:Read_a_Text_File
    ...
    # Wikipedia: maze shortest path wikipedia
        # https://en.wikipedia.org/wiki/Maze_solving_algorithm#Shortest_path_algorithm